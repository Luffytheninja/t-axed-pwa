...
const programs = [
    {
        id: "maternal-care",
        title: "Maternal Care",
        description: "Comprehensive support for expectant and new mothers from underprivileged backgrounds.",
        details: [
    ...
    },
    {
        ...
        description: "Empowering women with knowledge to make informed decisions for themselves and their families.",
        details: [
        ...
        <div className="pt-32 pb-24 bg-background">
            <div className="max-w-7xl mx-auto px-6">
                <div className="max-w-3xl mb-24">
                    <h2 className="text-sm font-bold tracking-widest uppercase text-primary mb-6">Our Initiatives</h2>
                    <h1 className="text-5xl md:text-7xl font-serif mb-8 leading-tight">
                        We provide <span className="italic font-light opacity-80">comprehensive</span> support structures.
                    </h1>
                    <p className="text-xl text-foreground/60 leading-relaxed font-light italic">
                        "Maternal health is the foundation of community health. When we support a mother, we protect a generation."
                    </p>
                </div>
                        ...
                        >
                            ...
                            <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                                ...
                                <div className="p-6 bg-white rounded-2xl border border-foreground/5 mb-10 inline-block shadow-sm">
                                    <p className="text-sm font-bold uppercase tracking-wider text-primary mb-1">Impact Highlight</p>
                ...
                <div className="mt-40 bg-foreground text-background rounded-[3rem] p-12 md:p-24 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <Button variant="gold" size="lg" className="px-10">Get Assistance</Button>
                        <Button variant="outline" size="lg" className="px-10 border-background/20 text-background">Partner With Us</Button>
                    </div>
                </div>
            </div>
        </div>
