    ...
    return (
        <div className="pt-32 pb-24">
            <div className="max-w-7xl mx-auto px-6">
                <h1 className="text-5xl md:text-6xl font-serif mb-16 text-center">Outcome & Transparency</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                    <div className="bg-white p-10 rounded-3xl shadow-sm border border-foreground/5 text-center">
                        ...
                        <div className="text-sm font-bold uppercase tracking-widest text-foreground/50">Women Supported</div>
                    </div>
                    <div className="bg-white p-10 rounded-3xl shadow-sm border border-foreground/5 text-center">
                        <div className="text-4xl font-serif font-bold text-primary mb-2">$450k+</div>
                        <div className="text-sm font-bold uppercase tracking-widest text-foreground/50">Funds Deployed</div>
                    </div>
                    <div className="bg-white p-10 rounded-3xl shadow-sm border border-foreground/5 text-center">
                        <div className="text-4xl font-serif font-bold text-primary mb-2">150</div>
                        <div className="text-sm font-bold uppercase tracking-widest text-foreground/50">Active Volunteers</div>
                    </div>
                </div>
                ...
                <div className="bg-foreground text-background rounded-[3rem] p-12 md:p-24 text-center flex flex-col items-center">
                    <h2 className="text-4xl md:text-6xl font-serif mb-8 max-w-3xl mx-auto leading-tight">
                        Our commitment to <span className="italic font-light opacity-80">total transparency.</span>
                    </h2>
                    <p className="text-lg md:text-xl text-background/60 mb-16 max-w-xl mx-auto italic font-light">
                        "Transparency is not just a policy, it is our duty to the women we serve and the donors who trust us with their support."
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6 w-full max-w-2xl mx-auto">
                        <Button variant="gold" size="lg" className="w-full sm:w-auto px-10 py-5 text-[12px] tracking-widest uppercase font-bold">
                            Download Audit Report
                        </Button>
                        <Button variant="outline" size="lg" className="w-full sm:w-auto px-10 py-5 text-[12px] tracking-widest uppercase font-bold border-background/20 text-background hover:bg-background hover:text-foreground">
                            View Financials
                        </Button>
                    </div>
                </div>
