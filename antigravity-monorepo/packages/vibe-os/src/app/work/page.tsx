            ...
            {folders.map((folder, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <span className="font-mono text-[10px] uppercase opacity-30 group-hover:opacity-100">
                    Open Folder
                  </span>
                ...
                {files.map((file, i) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center px-1">
                      <span className="font-mono text-[9px] uppercase tracking-widest opacity-20 group-hover:opacity-40">
                        {file.Name}
                      </span>
                    </div>
                  </motion.div>
