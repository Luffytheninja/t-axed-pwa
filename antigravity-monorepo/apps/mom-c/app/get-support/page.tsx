...
import { Button, Input } from '@antigravity/ui';
      ...
      <div className="max-w-2xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-foreground/60">
            We are here to help. Please fill out this simple form, and our team will reach out to
            you within 24 hours.
          </p>
        </div>
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-foreground/5">
          <form className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Input label="Phone Number" placeholder="+234..." type="tel" />
        ...
        <div className="mt-16 text-center text-sm text-foreground/40">
          <p>
            Your data is protected and used only for providing support.{' '}
