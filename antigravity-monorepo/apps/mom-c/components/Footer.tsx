    ...
    <footer className="bg-foreground text-background py-24 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="max-w-sm text-background/60 mb-10 leading-relaxed font-light">
              Empowering underprivileged women with accessible maternal support, education, and
              resources. Dedicated to protecting futures through transparency and care.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-5 text-[13px] text-background/50 font-light">
              ...
              <li>
                <Link href="/donate" className="hover:text-background transition-colors">
                  Support Our Cause
                </Link>
              </li>
              <li>
                <Link href="/get-support" className="hover:text-background transition-colors">
                  Get Assistance
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-5 text-[13px] text-background/50 font-light">
              <li>
                <Link href="/financials" className="hover:text-background transition-colors">
                  Financial Reports
                </Link>
              </li>
              <li>
                <Link href="/policies" className="hover:text-background transition-colors">
                  Privacy & Data
                </Link>
              </li>
              <li>
                <Link href="/safeguarding" className="hover:text-background transition-colors">
                  Safeguarding
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-background/5 pt-12 flex flex-col sm:flex-row justify-between items-center text-[11px] font-bold tracking-widest uppercase text-background/20">
          ...
          <div className="italic opacity-50 font-medium">Designed for Impact.</div>
        </div>
      </div>
    </footer>
  );
