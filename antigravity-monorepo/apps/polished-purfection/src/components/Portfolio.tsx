      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted font-serif italic max-w-2xl mx-auto">
            A showcase of precision, structure, and artistic intention. Each set is a unique
            collaboration.
          </p>
        </motion.div>
          ...
          {PORTFOLIO_ITEMS.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
                ...
                <p className="text-sm text-foreground/60 font-sans italic">{item.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
