    ...
    <section className="min-h-screen flex items-center justify-center overflow-hidden border-b border-white/5 relative group">
      ...
      <div className="z-10 container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="text-left order-2 md:order-1">
          ...
          <p className="text-xl text-muted mb-4 font-serif italic">Clean. Strong. Addictive.</p>
          <p className="text-md text-foreground/60 mb-8 max-w-md font-sans leading-relaxed">
            A timeless Gel-X set with flawless structure and a polished finish. Perfect for everyday
            wear with elevated quality.
          </p>
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col items-center">
          ...
          <div className="w-full max-w-sm mt-12 space-y-8">
            <div>
              <span className="text-white/40 text-[10px] uppercase tracking-[0.2em] mb-4 block">
                Length
              </span>
        ...
        <div className="text-left">
          ...
          <p className="text-xl text-muted mb-4 font-serif italic">The one they ask about.</p>
          <p className="text-md text-foreground/60 mb-8 max-w-md font-sans leading-relaxed">
            Custom details, refined finishes, and main-character energy. Designed to stand out
    ...
    <section className="min-h-screen flex items-center justify-center overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="text-left order-2 md:order-1">
          ...
          <p className="text-xl text-muted mb-4 font-serif italic">Designed, not rushed.</p>
          <p className="text-md text-foreground/60 mb-8 max-w-md font-sans leading-relaxed">
            A fully customized set built from scratch. For clients who want something unique and
            intentional.
          </p>
          <button className="text-gold border-b border-gold/30 pb-1 hover:border-gold transition-colors font-serif italic">
            From ₦15,000
        ...
        <div className="relative flex items-center justify-center order-1 md:order-2">
          <div className="relative w-full aspect-[3/4] max-w-md flex items-center justify-center">
            ...
            <div className="absolute -bottom-16 flex gap-8">
              <button
                onClick={prev}
                className="p-4 text-white/50 hover:text-gold transition-colors"
              >
                <ChevronLeft size={24} />
              </button>
              <button
