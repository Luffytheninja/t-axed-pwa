...
export default function Pricing() {
  return (
    <section
      id="pricing"
      className="py-32 px-6 bg-background relative overflow-hidden flex flex-col items-center border-t border-white/5"
    >
      {/* Background Ambience */}
      ...
      >
        ...
        <p className="text-muted font-serif italic text-lg leading-relaxed">
          Pricing reflects the time, precision, and high-quality materials required to ensure your
          set lasts and maintains its health.
        </p>
      </motion.div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted font-sans font-light">
            <li className="flex justify-between">
              <span>Soak Off (External)</span> <span className="text-gold">₦3,000</span>
            </li>
            <li className="flex justify-between">
              <span>Soak Off (My Work)</span> <span className="text-gold">₦1,500</span>
            </li>
            <li className="flex justify-between">
              <span>Nail Repair (Per Finger)</span> <span className="text-gold">₦2,500</span>
            </li>
            <li className="flex justify-between">
              <span>Charms (Per Finger)</span> <span className="text-gold">₦700</span>
            </li>
          </ul>
        </div>
      </motion.div>
  ...
  return (
    ...
    >
      <div className="mb-4 md:mb-0 max-w-md">
        <h3 className="text-3xl font-serif text-white group-hover:text-gold transition-colors duration-500 mb-2">
          {title}
        </h3>
