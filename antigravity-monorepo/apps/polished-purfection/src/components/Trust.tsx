...
const PILLARS = [
  ...
  },
  {
    title: 'Precision',
    description:
      'Meticulous cuticle work and balanced architecture. Every set is structurally sound.',
  },
  {
    title: 'Intentionality',
    description:
      'Bespoke designs tailored to your aesthetic. No rushing, just pure artistic focus.',
  },
];
