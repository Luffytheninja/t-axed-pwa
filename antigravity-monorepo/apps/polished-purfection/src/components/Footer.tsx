        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="md:col-span-2">
            <a href="#" className="font-serif text-4xl tracking-tighter text-white mb-8 block">
              Polished
              <br />
              Purfection<span className="text-gold">.</span>
            </a>
            <p className="text-muted font-sans font-light max-w-md leading-relaxed">
              Crafting high-integrity, artistic nail sets for those who value precision and
              intentionality. Campus-based, globally inspired.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-muted font-sans font-light">
              ...
              <li>
                <a href="https://tiktok.com" className="hover:text-gold transition-colors">
                  TikTok
                </a>
              </li>
              <li>
