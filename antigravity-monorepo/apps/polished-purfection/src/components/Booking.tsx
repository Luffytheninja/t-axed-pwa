      ...
      <div className="container max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted font-sans leading-relaxed max-w-2xl mx-auto font-light">
            Luxury is intentional. Every set is crafted with care, precision, and time. Polished
            Purfection operates on limited weekly availability to ensure every client receives an
            unrushed experience.
          </p>
        </motion.div>
