...
const videos = [
    { id: "1", title: "THRONE (DIDN'T DEY) - OFFICIAL VIDEO", platform: "YouTube", thumbnail: "https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?q=80&w=1000&auto=format&fit=crop" },
    { id: "2", title: "YUNNO THE DRILL - EP RELEASES", platform: "YouTube", thumbnail: "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?q=80&w=1000&auto=format&fit=crop" },
    { id: "3", title: "SONS OF GOD (OAU RAPPERS DISS) - OFFICIAL RE-UP", platform: "YouTube", thumbnail: "https://images.unsplash.com/photo-1514525253361-bee8a18744ad?q=80&w=1000&auto=format&fit=crop" },
];
            ...
            <section className="px-6 md:px-24 mb-32">
                <header className="mb-12 flex justify-between items-end">
                    <div className="space-y-4">
                        <span className="text-accent text-[10px] font-bold tracking-[0.4em] uppercase block">Visuals</span>
                    ...
                    {videos.map((vid, idx) => (
                        ...
                        >
                            <div className="relative aspect-video bg-charcoal border border-accent/10 overflow-hidden">
                                <img src={vid.thumbnail} alt={vid.title} className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-700" />
                                ...
                                <div className="absolute bottom-6 left-6 right-6">
                                    <span className="text-[10px] font-bold tracking-widest text-accent mb-1 block uppercase">{vid.platform}</span>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-8 text-cloudDancer/70 text-base leading-relaxed font-light">
                            <p className="text-xl text-cloudDancer italic">
                                "r3my jay is a sonic experimentalist blurring the lines between Alternative Hip-Hop and dark, atmospheric vibes."
                            </p>
                            <p>
                                Born Owolabi Jeremy, the artist known as r3my jay exists at the intersection of logic and chaos. A Law student by day and a genre-bending visionary by night, r3my has carved a unique space in the Nigerian alternative scene through his distinct &lsquo;Sons of God&rsquo; philosophy and a viral, high-velocity approach to rap.
                            </p>
                            <p>
                                Known for his cult-followed project &lsquo;Agbada&rsquo; and the raw energy of his viral diss tracks, r3my sound is characterized by heavy bass, intricate wordplay, and an unapologetic experimental edge. With over 1 million impressions on his breakout performances, he continues to lead The 3NITY—a community of fans dedicated to the fusion of art, fashion, and sound.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {achievements.map((item, i) => (
                                <div key={i} className="flex gap-4 items-start p-4 bg-accent/5 border border-accent/10">
                                    <CheckCircle2 className="text-accent shrink-0" size={18} />
                                    <span className="text-xs font-bold uppercase tracking-wider text-cloudDancer/80">{item}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="lg:col-span-5 space-y-12">
                    <div className="p-8 border border-accent/20 bg-charcoal relative">
                        ...
                        <header className="mb-8">
                            ...
                            <p className="text-[10px] text-cloudDancer/40 font-bold uppercase">Industry Use Only</p>
                        </header>
                        ...
                        <div className="mt-12 space-y-4">
                            <p className="text-[10px] font-bold text-cloudDancer/30 uppercase tracking-[0.2em]">As Seen On</p>
                    ...
                    <div className="p-8 border border-accent/10 bg-glass text-center space-y-4">
                        ...
                        <a href="/archive" className="inline-block px-6 py-2 border border-accent/30 text-[9px] font-bold uppercase tracking-widest hover:border-accent transition-colors">OPEN FORM</a>
                    </div>
                </div>
            </section>
        </div>
