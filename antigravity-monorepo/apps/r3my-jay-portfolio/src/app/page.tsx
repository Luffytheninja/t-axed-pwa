        ...
        <div className="relative w-full overflow-hidden">
            ...
            <section className="relative h-screen w-full flex items-center justify-center bg-black overflow-hidden">
                ...
                <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-4 opacity-40">
                    ...
                    <span className="text-[10px] tracking-widest rotate-90 origin-left ml-1 translate-y-4">SCROLL</span>
                </div>
            </section>
                ...
                <div className="tri-grid items-start">
                    ...
                    <div className="col-span-1 space-y-6 pt-12 md:pl-12 border-l border-accent/10">
                        <div className="space-y-2">
                            <span className="text-accent text-[10px] font-bold tracking-widest uppercase">Official Video</span>
                        ...
                        <p className="text-sm text-cloudDancer/60 leading-relaxed font-light">
                            The flagship visual for the &lsquo;YUNNO THE DRILL&rsquo; era. A sonic declaration of authority and experimental excellence directed by the 3NITY collective.
                        </p>
                        <div className="pt-4 flex flex-col gap-3">
                            <a href="https://youtu.be/ivVHy_Z_iFk" target="_blank" className="text-xs font-bold underline decoration-accent hover:text-accent transition-colors uppercase">WATCH ON YOUTUBE</a>
                            <a href="https://ffm.to/r3myjay-throne" target="_blank" className="text-xs font-bold underline decoration-accent hover:text-accent transition-colors uppercase">STREAM THE MOVEMENT</a>
                        </div>
                    </div>
                </div>
            </section>
