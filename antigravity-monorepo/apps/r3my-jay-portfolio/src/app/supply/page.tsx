...
const products = [
  ...
  {
    id: '2',
    name: 'SONS OF GOD OVERSIZED TEE',
    price: '₦25,000',
    status: 'SOLD OUT',
    image:
  ...
  {
    id: '4',
    name: '3NITY CHAIN (LIMITED)',
    price: '₦120,000',
    status: 'COMING SOON',
    image:
      'https://images.unsplash.com/photo-1611085583191-a3b1a30a8a0a?q=80&w=1000&auto=format&fit=crop',
  },
];
      ...
      <header className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
        <div className="space-y-4">
          ...
          <p className="text-cloudDancer/50 text-sm leading-relaxed max-w-md font-light">
            Wear the movement. Each piece is an extension of the 3NITY philosophy—structured,
            experimental, and unapologetically alternative.
          </p>
        </div>
        ...
        <div className="flex flex-col md:items-end gap-4">
          ...
          <p className="text-[9px] text-cloudDancer/30 font-bold uppercase tracking-[0.2em]">
            Next Drop: &lsquo;THE VOID COLLECTION&rsquo; 2026
          </p>
        </div>
      </header>
        ...
        {products.map((product, idx) => (
          ...
          >
            ...
            <div className="relative z-10 flex justify-between items-start">
              <div className="flex flex-col">
                <span className="text-[10px] text-cloudDancer/30 font-bold tracking-widest uppercase">
                  ID: 00{product.id}
                </span>
                <span
                  className={`text-[9px] font-black px-2 py-0.5 mt-2 inline-block border ${
              ...
              <ShoppingBag
                className="text-accent/20 group-hover:text-accent transition-colors"
                size={20}
              />
            </div>
      ...
      <section className="mt-48 relative overflow-hidden">
        ...
        <div className="relative z-10 py-32 flex flex-col items-center text-center gap-8">
          ...
          <p className="max-w-xl text-cloudDancer/60 text-sm font-light">
            Exclusive access to archival pieces, early unreleased demos, and the inner circle of The
            3NITY. We don&rsquo;t send spam; we send access.
          </p>
