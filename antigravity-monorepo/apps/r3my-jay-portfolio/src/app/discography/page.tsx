  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-48 px-6 md:px-24">
      ...
      <header className="relative z-10 mb-20 space-y-4">
        ...
        >
          Explore the evolving sound of r3my jay. From the cultural echoes of{' '}
          <span className="text-cloudDancer italic">Agbada</span> to the aggressive energy of{' '}
          <span className="text-cloudDancer italic">Sons of God</span>. Organized by eras and moods
          for the complete 3NITY experience.
        </motion.p>
      </header>
