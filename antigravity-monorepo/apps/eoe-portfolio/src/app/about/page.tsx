            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-24">
                ...
                <div className="md:col-span-5 md:col-start-1">
                    ...
                    <p className="text-xl leading-relaxed mb-12">
                        EOE is a multidisciplinary creative brand operating at the intersection of cultural research and visual craftsmanship.
                        We believe that the most powerful expressions are often the most restrained.
                    </p>
                    <p className="text-lg text-muted leading-relaxed">
                        Founded on the principles of architectural precision and gallery-grade aesthetic standards,
                        EOE serves as a vehicle for projects that demand high-end intentionality and a timeless visual perspective.
                    </p>
                </div>
