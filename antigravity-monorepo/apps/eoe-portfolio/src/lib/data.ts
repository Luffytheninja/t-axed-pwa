...
export const projects: Project[] = [
  // PHOTOGRAPHY
  {
    ...
    description:
      'An ethereal exploration of the human form merged with botanical elements, challenging the boundaries between the organic and the constructed.',
  ...
  },
  {
    ...
    description:
      'A study of isolation and vibrant contrast against the muted tones of the Sahelian landscape.',
  ...
  // PAINTING
  {
    ...
    dimensions: '120 x 120 cm',
    description:
      'A vibrant, impasto exploration of light and dwelling, where the sky as much as the earth defines the structure of the home.',
  ...
  },
  {
    ...
    dimensions: '100 x 100 cm',
    description:
      'An abstract depiction of human connection, utilizing heavy textures and primal symbols to evoke a sense of shared history.',
