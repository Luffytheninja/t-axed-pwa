                ...
                <div className="px-6 pb-6 space-y-6">
                    ...
                    <div className="bg-emerald-500/5 rounded-2xl p-4 border border-emerald-500/10">
                        ...
                        <p className="text-[10px] text-white/50 leading-relaxed">
                            Based on organic 15% growth, your annual take-home will reach <span className="text-white font-bold">{formatCurrency(projectionData[4].takeHome)}</span> by 2030. Scaling insurance premiums proportionately can save an additional ₦450k in projected tax.
                        </p>
                    </div>
                </div>
            )}
