...
export default function SummaryCard({ annualIncome, annualTax, effectiveRate, userCategory }: SummaryCardProps) {
        ...
        >
            <div className="relative z-10 flex flex-col gap-6">
                <div className="flex justify-between items-start">
                    <div>
                        <div className="text-xs uppercase tracking-widest opacity-80 mb-1">Fiscal Freedom Score</div>
