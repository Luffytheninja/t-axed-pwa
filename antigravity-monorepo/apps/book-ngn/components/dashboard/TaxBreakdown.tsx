            ...
            <div key={idx} className="space-y-1.5">
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider">
                ...
                <span className="font-mono">
                  <AnimatedNumber value={band.taxInBand} currency />
                </span>
              </div>
              <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{
                    width: `${(band.taxableInBand / (results.chargeableIncome || 1)) * 100}%`,
                  }}
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="text-[10px] uppercase tracking-[0.2em] opacity-40 px-2">
              Reliefs & Allowances
            </div>
            <div className="bg-black/20 rounded-2xl border border-white/5 overflow-hidden">
              {[
                ...
                <div
                  key={i}
                  className="flex justify-between p-3 px-4 border-b border-white/5 last:border-0 hover:bg-white/[0.02]"
                >
