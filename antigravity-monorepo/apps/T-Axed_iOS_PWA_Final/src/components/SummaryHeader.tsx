...
export default function SummaryHeader({ annualIncome, annualTax, currency = '₦' }: SummaryHeaderProps) {
            ...
            <div className="relative z-10">
                <div className="flex justify-between items-start mb-6 md:mb-8">
                    <div className="flex-1 min-w-0 pr-4">
                        <p className="text-gray-500 text-xs font-bold uppercase tracking-[0.2em] mb-2">Total Annual Income</p>
                        <div className="flex items-baseline gap-1 mt-1">
                            <span className="text-xl md:text-2xl font-medium text-emerald-600/80">{currency}</span>
                            <h2 className="text-4xl sm:text-4xl md:text-6xl font-black tracking-tighter text-white truncate w-full">
                                {isVisible ? (
                                    <AnimatedNumber value={annualIncome} />
                                ) : (
                                    '•••••••'
                                )}
                            </h2>
                ...
                <div className="flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-sm">
                    <div className="flex-1 min-w-0">
                        <p className="text-gray-500 text-[10px] md:text-xs font-bold uppercase tracking-widest mb-1">Est. Tax Liability</p>
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-gray-500 text-[10px] md:text-xs font-bold uppercase tracking-widest mb-1">Effective Rate</p>
