...
export default function TakeHomeAndOptimization({ results, lifePremium }: TakeHomeAndOptimizationProps) {
    return (
        <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="ios-card bg-indigo-600 p-8 text-white border-0 shadow-xl shadow-indigo-200">
                ...
                <div className="space-y-6">
                    <div>
                        <p className="text-white/60 text-sm font-medium mb-1 uppercase tracking-wider">Monthly</p>
                        <p className="text-5xl font-bold tracking-tight">{formatCurrency(results.monthlyTakeHome)}</p>
                    </div>

                    <div className="grid grid-cols-2 gap-6 pt-6 border-t border-white/20">
                        <div>
                            <p className="text-white/60 text-sm font-medium mb-1 uppercase tracking-wider">Annual</p>
                            <p className="text-xl font-bold">{formatCurrency(results.annualTakeHome)}</p>
                        </div>
                        <div>
                            <p className="text-white/60 text-sm font-medium mb-1 uppercase tracking-wider">Eff. Rate</p>
