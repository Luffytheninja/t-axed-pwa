...
export default function TaxResultsBreakdown({ results }: TaxResultsBreakdownProps) {
    ...
    return (
        <motion.div
            ...
            className="space-y-6"
        >
            <motion.div variants={item} className="ios-card bg-gradient-to-br from-emerald-600 via-green-600 to-green-700 p-8 text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2 text-emerald-100/80 text-sm font-medium">
                            ...
                            <span><AnimatedNumber value={results.monthlyTakeHome} format={formatCurrency} />/mo</span>
                        </div>
                        <div className="flex items-center gap-2 text-emerald-100/80 text-sm font-medium">
                            <TrendingUp className="w-4 h-4" />
                            <span><AnimatedNumber value={results.effectiveRate} format={(v) => `${v.toFixed(1)}%`} /> Effective Tax</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="ios-input-group">
                            <div className="ios-input-item py-3 px-5 flex justify-between items-center">
                                ...
                                <span className="text-sm font-bold text-gray-900">-<AnimatedNumber value={results.pension} format={formatCurrency} /></span>
                            </div>
                            <div className="ios-input-item py-3 px-5 flex justify-between items-center border-t border-gray-50">
                                ...
                                <span className="text-sm font-bold text-gray-900">-<AnimatedNumber value={results.nhf} format={formatCurrency} /></span>
                            </div>
                            <div className="ios-input-item py-3 px-5 flex justify-between items-center border-t border-gray-50">
                                <span className="text-sm font-medium text-gray-600">Insurance Relief</span>
                                <span className="text-sm font-bold text-emerald-600">-<AnimatedNumber value={results.lifeInsuranceRelief} format={formatCurrency} /></span>
                            </div>
                            <div className="ios-input-item py-3 px-5 flex justify-between items-center border-t border-gray-50">
                                <span className="text-sm font-medium text-gray-600">Operating Expenses</span>
                                <span className="text-sm font-bold text-gray-900">-<AnimatedNumber value={results.totalBusinessExpenses} format={formatCurrency} /></span>
                            </div>
                            <div className="bg-gray-50/80 px-5 py-4 flex justify-between items-center border-t border-gray-100">
                                ...
                                <span className="text-sm font-black text-indigo-600">-<AnimatedNumber value={results.totalDeductions} format={formatCurrency} /></span>
                            </div>
                        </div>
                    </div>
