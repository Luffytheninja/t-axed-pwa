...
export default function InputSection({
    ...
    voluntaryPension, setVoluntaryPension,
            ...
            <div className="bg-zinc-900 rounded-3xl p-6 border border-white/5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {CATEGORIES.map((cat) => (
                        ...
                        >
                            <cat.icon className={`w-6 h-6 ${userCategory === cat.id ? 'text-white' : 'text-emerald-500'}`} />
                            <div>
                                <div className="text-xs font-bold leading-tight uppercase tracking-wider">{cat.label}</div>
                                <div className={`text-[10px] mt-1 opacity-70 ${userCategory === cat.id ? 'text-emerald-50' : 'text-gray-500'}`}>{cat.desc}</div>
                            </div>
                        </button>
                    ))}
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-zinc-900 rounded-3xl p-6 border border-white/5">
                    ...
                    <div className="space-y-4 mb-6">
                        <div>
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Base Monthly Income</label>
                            <input
                                type="number"
                                value={monthlyIncome}
                        ...
                        <div>
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Headcount</label>
                            <input
                                type="number"
                                value={employeeCount}
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Annual Rent</label>
                            <input
                                type="number"
                                value={rentPaid}
                        ...
                        <div>
                            <label className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Utilities (Monthly)</label>
                            <input
                                type="number"
                    ...
                    <div className="space-y-4 mb-6">
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Life Insur.</label>
                            </div>
                            <input
                                type="number"
                                value={lifePremium}
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Medical</label>
                            </div>
                            <input
                                type="number"
                                value={healthPremium}
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">NHIA</label>
                            </div>
                            <input
                                type="number"
                                value={nhiaVoluntary}
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Vol. Pension</label>
                            </div>
                            <input
                                type="number"
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <label className="text-xs font-bold text-gray-500 uppercase tracking-widest">Mortgage Int.</label>
                            </div>
                            <input
                                type="number"
