    ...
    <>
      ...
      <section className="container-grid pt-40 pb-20">
        <div className="col-span-12 sm:col-span-8 space-y-6">
          {!currentPath.length ? (
            <>
              <span className="font-mono text-[10px] uppercase tracking-[0.5em] text-rupture font-bold">
              ...
              <p className="text-lg opacity-60 max-w-md">
                This is where the madness leaks through the cracks. No essential information lives
                here.
              </p>
            </>
          ) : (
            <div className="space-y-4">
              ...
              >
                <span className="font-mono text-[10px] uppercase tracking-widest opacity-40 group-hover:text-rupture">
                  ← Return to {currentPath[currentPath.length - 2] || 'Lab'}
                </span>
          ...
          {!experimentalMode ? (
            <div className="py-40 flex flex-col items-center justify-center border-y border-rupture/20 bg-rupture/5 rounded-3xl space-y-8 group transition-all hover:bg-rupture/10">
              ...
              <div className="text-center space-y-2">
                <h2 className="text-2xl font-bold uppercase tracking-widest text-rupture">
                  Access Restricted
                </h2>
                <p className="font-mono text-[10px] uppercase tracking-widest opacity-40">
                  System requires manual override for experimental access.
                </p>
              </div>
              <button
                  ...
                  {folders.map((folder, i) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
                        <span className="font-mono text-[9px] uppercase tracking-widest text-rupture">
                          Explore Sector
                        </span>
                      </div>
                    </motion.button>
                      ...
                      {files.map((file, i) => (
                        ...
                        >
                          ...
                          <div className="flex justify-between items-start">
                            <span className="font-mono text-[10px] uppercase tracking-widest opacity-40 truncate flex-1">
                              {file.Name}
                            </span>
                          </div>
                        </motion.div>
                ...
                <div className="col-span-12 mt-20 border-t border-rupture/10 pt-20">
                  <div className="text-center mb-10">
                    <span className="font-mono text-[10px] uppercase tracking-widest opacity-40">
                      System // Kinetic Stress Test
                    </span>
                    <h3 className="text-2xl font-bold uppercase tracking-tighter mt-2">
                      Interact and Disturb
                    </h3>
                  </div>
                  <div className="h-[80vh] relative overflow-hidden rounded-3xl border border-rupture/10 bg-rupture/[0.02] dashed-grid-rupture">
                    {[0, 1, 2, 3, 0, 1].map((idx, i) => (
                      ...
                      >
                        <HeroPng
                          index={idx}
                          className="w-48 h-48 sm:w-64 sm:h-64 opacity-80 hover:opacity-100"
                        />
                      </motion.div>
                    ))}
                  </div>
            ...
            >
              ...
              <div className="mt-8 flex justify-between items-end border-t border-rupture/10 pt-8">
                <div className="space-y-1">
                  <span className="font-mono text-[10px] uppercase tracking-widest text-rupture">
                    Sector Artifact // Experimental
                  </span>
